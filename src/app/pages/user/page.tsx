    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen">
            ...
            <div className="flex items-center space-x-7 space-y-4  ">
                <div className="bg-[#101829] rounded-2xl p-5 w-full flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        <div className="bg-[#1e293b] text-white p-3 rounded-lg flex justify-evenly items-center">
                            ...
                            <button
                                onClick={copyAddress}
                                className="z-10 hover:bg-[#374151] p-2 rounded-full transition w-8 h-8"
                                aria-label="Copy wallet address"
                            >
                                <Image
                                    src="https://www.svgrepo.com/show/522102/duplicate.svg"
                                    alt=""
                                    width={24}
                                    height={24}
                                />
                    ...
                    {walletAddress && (
                        <button
                            ...
                            className="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded transition w-full mt-4"
                        >
                            Desconectar Wallet
                        </button>
                    )}
                ...
                <div className="bg-[#101829] rounded-2xl p-5 w-full "></div>
            </div>
        </div>
    );
}
